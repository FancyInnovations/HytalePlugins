...
public class PlayerLocationZPlaceholder implements PlaceholderProvider {

    public static final PlayerLocationZPlaceholder INSTANCE = new PlayerLocationZPlaceholder();

    private PlayerLocationZPlaceholder() {
    }
    ...
    public String parse(@Nullable FancyPlayer fp, @NotNull String input) {
        ...
        return NumberUtils.FORMAT_TWO_DECIMALS.format(transform.getPosition().getZ());
    }
}
